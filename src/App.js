    ...
    <div className="App">
      ...
      <Routes>
        <Route element={<Private user={user} />}>
          ...
          <Route path='/:id' element={<SinglePost single={single} setSingle={setSingle} setPostdata={setPostdata} userinfo={userinfo} user={user} postdata={postdata}/>} />
          <Route path='/settings' element={<Settings setuserinfo={setUserinfo}/>} />
          <Route path='/write' element={<Write  single={single} userinfo={userinfo} user={user} postdata={postdata} setpostdata={setPostdata}/>} />
        </Route>
