    ...
    <div className="App">
      ...
      <Routes>
        <Route element={<Private user={user} />}>
          ...
          <Route path='/:id' element={<SinglePost setUpdate={setUpdate} single={single} setSingle={setSingle} setPostdata={setPostdata} userinfo={userinfo} user={user} postdata={postdata}/>} />
